...
/*   Updated: 2024/02/29 17:43:52 by ealislam         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
char **error)
{
	...
	str1 = unsigned_to_str(pid, error);
	str2 = unsigned_to_str(here_doc_i, error);
	doc_name = ft_strjoin(str1, str2, error);
	str1 = doc_name;
