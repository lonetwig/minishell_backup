...
/*   Updated: 2024/03/07 10:08:22 by ealislam         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */

#include "../../../minibash.h"

static int	get_fds(char *s, int *input, int *output, char **err)
{
	char	**arr;
	int		i;
