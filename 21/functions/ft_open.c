...
/*   Updated: 2024/05/12 13:41:24 by ealislam         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
// this is a user made open function
// it uses a static variable (list) to keep track of all opened files fd
// in case of passing ( 1 ) to close mode it closes all the files opened
// in case of passing (> 1) to close mode it closes the fd passed as arg
//  -in close mode and replace it with -1
// returns the fd of the file created
